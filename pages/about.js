    ...
    return ( 
        <>
            ...
            <div>
                ...
                <p className = {styles.paragraph}>Mit Hilfe mehrerer Open-Source-JavaScript-Frameworks bietet die SAMMwise-Anwendung einen intuitiven, seitenorientierten Workflow zur Durchführung einer SAMM-Bewertung, gekoppelt mit dynamischen Grafiken zur Visualisierung der Bewertungsergebnisse.
                </p>
              ...
              <h2 className = {styles.title}>Zukünftige Erweiterungen</h2>
                ...
                <p className = {styles.paragraph}>Version 1.0 - Die erste Version von SAMMwise wurde im Juli bis Oktober 2021 vom Application Security Services Team bei Datacom Neuseeland entwickelt. Das Tool wurde als Open-Source-Projekt veröffentlicht und dem OWASP SAMM-Projekt gespendet.
                </p>
            </div>
        </>
        );
